...
local function is_class(obj) return get_mt(obj, "type") == "class" end
...
local function get_name(obj) return get_mt(obj, "name") end

local function get_parent(obj) return get_mt(obj, "parent") end

local function get_class(obj) return get_mt(obj) end
