...
multimethod.MultipleSignaturesException = exception("MultipleSignaturesException", "duplicate type signature found")
...
-- @param self multimethod
-- @param f callable
-- @param ... type specs
function multimethod.set(self, f, ...)
	self.sig[{ ... }] = f
end
...
-- @param self multimethod
-- @param ... type specs
-- @return callable or throw error
function multimethod.get(self, ...)
