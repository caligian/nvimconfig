Keybinding.bind(
  ...
  { "xd", "<cmd>DockREPL sh<CR>", { name = "shell_dock" } },
  { "xx", "<cmd>StartREPL sh<CR>", { name = "shell_start" } },
  ...
  { "rd", "<cmd>DockREPL<CR>", { name = "repl_dock" } },
  { "rr", "<cmd>StartREPL<CR>", { name = "repl_start" } },
  ...
  { "rc", "<cmd>TerminateInputREPL<CR>", { name = "repl_terminate_input" } }
)
