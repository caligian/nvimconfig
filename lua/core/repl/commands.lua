...
local function write_shell_visual_range()
    write('sh', 'v')
end

local function write_shell_line()
    write('sh', 'l')
end

local function write_shell_buffer()
    write('sh', 'b')
end

local function write_shell_till_point()
    write('sh', '.')
end

local function write_shell_input()
    write('sh', 'i')
end

local function write_line()
    write(vim.bo.filetype, 'l')
end

local function write_buffer()
    write(vim.bo.filetype, 'b')
end

local function write_till_point()
    write(vim.bo.filetype, '.')
end

local function write_input()
    write(vim.bo.filetype, 'i')
end

local function write_visual_range()
    write(vim.bo.filetype, 'v')
end
