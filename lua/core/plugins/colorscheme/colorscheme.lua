...
function Colorscheme.loadall()
	...
	local user_themes = extend(glob(user.user_dir, "colors/*.vim"), glob(user.user_dir, "colors/*.lua"))
	local installed = extend(glob(user.plugins_dir, "*/colors/*.vim"), glob(user.plugins_dir, "*/colors/*.lua"))
