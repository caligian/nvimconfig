...
function font.main()
  ...
  kbd.map('n', '<leader>hf', tfont.run_picker, 'fonts picker')
  kbd.map('n', '<localleader>+', function () font.current():incheight() end, 'inc font size')
  kbd.map('n', '<localleader>-', function () font.current():decheight() end, 'dec font size')
end
